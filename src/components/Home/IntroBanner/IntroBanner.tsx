...
const IntroBanner = () => {
    return (
        <div className="relative h-[480px] mt-16   overflow-hidden flex items-center justify-center text-center">
            ...
            {/* Content */}
            <div className="relative z-20  px-4 text-white flex flex-col items-center justify-center">
                <h1 className={`${cinzel.className} text-3xl sm:text-4xl md:text-5xl font-bold uppercase leading-16 text-center  w-[1150px]`}>
                    Dive into the World of Sumptuous Sum Dim Sum
                </h1>


                <p className="mt-6 text-[16px] text-[#E6F6FC] leading-6 w-[850px] h-[96px] opacity-85 mb-4">
