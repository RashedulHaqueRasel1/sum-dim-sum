                ...
                <div className="relative w-full md:w-1/3 bg-[#F7E7E8] flex flex-col items-center text-left px-10 pt-20 pb-6">
                    ...
                    <div className="relative z-10 w-full h-full flex flex-col justify-center">
                        <div className="text-left">
                            <h3
                                className={`${poppins.className} text-2xl font-semibold mb-4 text-[#0C0C0C]`}
                            >
                                Contact Information
                            </h3>
                            <p className="text-[16px] mb-1 text-[#0C0C0C]">
                                Maui, Hawaii, USA
                            </p>
                            <p className="text-[16px] mb-1 text-[#0C0C0C]">
                                Call us: +1234567890{" "}
                            </p>
                            <p className="text-[16px] mb-6 text-[#0C0C0C]">
                                Whatsapp: +1234567890{" "}
                            </p>

                            <h4
                                className={`${poppins.className} text-2xl text-[#0C0C0C] font-semibold mb-2`}
                            >
                                Follow Us
                            </h4>
